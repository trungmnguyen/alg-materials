 ...
 */
func findIndicesUnOptimized(of value: Int, in array: [Int]) -> Range<Int>?
{
...
func startIndex(of value: Int,
    ...
    if array[middleIndex] == value {
        ...
        return startIndex(of: value, in: array, range: middleIndex..<range.lowerBound)
    }
}
...
let array = [1, 2, 3, 3, 3, 4, 5, 5]
if let startIndex = startIndex(of: 3, in: array, range: 0..<array.count) {
    print(startIndex)
}
if let endIndex = endIndex(of: 3, in: array, range: 0..<array.count) {
    print(endIndex)
}
