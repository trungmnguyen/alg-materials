...
extension Graph where Element: Hashable {
  ...
  func depthFirstSearch(from start: Vertex<Element>)
    -> [Vertex<Element>] {
      ...
      // Add your code here
        depthFirstSearch(from: start, visited: &visited, pushed: &pushed)
      
      return visited
  }
    
    private func depthFirstSearch(from source: Vertex<Element>, visited: inout [Vertex<Element>], pushed: inout Set<Vertex<Element>>) {
